...
const DATA_DIR = join(homedir(), ".oh-my-claudecode/yith");
...
export function loadConfig(): YithArchiveConfig {
...
export function loadSnapshotConfig(): {
  ...
  return {
    ...
    dir: env["SNAPSHOT_DIR"] || join(homedir(), ".oh-my-claudecode/yith", "snapshots"),
  };
}
...
export function getStandalonePersistPath(): string {
  ...
  return (
    ...
    join(homedir(), ".oh-my-claudecode/yith", "standalone.json")
  );
}
